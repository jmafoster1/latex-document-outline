...
const SPECIAL_MACROS = {
    ...
    // Section macros
    part: { signature: "o m" },
    chapter: { signature: "o m" },
    section: { signature: "o m" },
    subsection: { signature: "o m" },
    subsubsection: { signature: "o m" },
};
...
const SPECIAL_ENVIRONMENTS = {
    ...
    table: { signature: "m", renderInfo: { alignContent: true } },
    figure: { signature: "m", renderInfo: { alignContent: true } },
