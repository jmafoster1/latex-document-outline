  ...
  constructor(structure) {
    ...
    atom.workspace.observeTextEditors(function(editor){
      editor.onDidSave(function(event) {
        self.structure = self.manager.getStructure(self.mainFile, (self.structure || {}), {part:0, chapter:0, section:0, subsection:0, subsubsection:0});
        self.updateView();
      });
    });
  }
                              ...
                              if (subsection.title) {
                                htmlString += `<li>
                                                <div>
                                                  ...
                                                  <a class="subsectionopen" data-line="${subsection.line}" data-file="${subsection.file}">
                                                    ${subsection.title}
                                                  </a>
                                                </div>`;
                              }
